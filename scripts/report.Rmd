...
clonotypes <- fread(snakemake@input[[1]], sep="\t", header=TRUE, select = c("V_SHM", "id", "FR1_SHM", "CDR1_SHM", "FR2_SHM", "CDR2_SHM", "FR3_SHM", "cdr3_aa", "v_call", "j_call", "count", "timepoint"))
sprintf("The clonotypes table has %d rows", nrow(clonotypes))

# Read merged processed sample table
aligned_sequences <- fread(snakemake@input[[2]], sep="\t", header=TRUE, select = c("V_SHM", "id", "FR1_SHM", "CDR1_SHM", "FR2_SHM", "CDR2_SHM", "FR3_SHM", "cdr3_aa", "v_call", "j_call", "count", "timepoint"))
